...
contract Blacklistable is Initializable, AccessControlUpgradeable {
     ...
     */
    function setBlacklistEnabled(bool enabled) public onlyRole(BLACKLISTER_ROLE) {
     ...
     */
    function addToBlacklist(address addressToAdd) public  onlyRole(BLACKLISTER_ROLE) {
